...
You pull out your handy **Oasis And Sand Instability Sensor** and analyze your surroundings. The OASIS produces a report of many values and how they are changing over time ([(your puzzle input)](data/input.txt)). Each line in the report contains the **history** of a single value. For example:
